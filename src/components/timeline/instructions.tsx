  ...
  return (
    ...
    <div className="p-6">
      ...
      <pre className="text-muted-foreground text-wrap overflow-auto max-h-[40dvh] sm:max-h-[60dvh] ">
        1. Double press to add a glyph block, choose Glyph Zone numbers to add to that zone, a zone
        can target multiple glyphs (depending on device). Chose the add all button to add all glyphs
        to that instance.
        <br />
        2. Right-click and press on delete to remove, or select a block and then click delete icon.
        <br />
        ...
        <br />
        5. Click on the red timeline bar to seek audio, right-click it to set loops and to toggle
        glyph zone number, helpful stuff!
        <br /> <br />
        Extra Info:
